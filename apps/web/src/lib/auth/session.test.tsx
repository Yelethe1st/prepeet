 ...
 *
 * Fresh because a shared cache would carry one test's answer into the next, and
 * the first test to run would decide what every other one saw. Retries off
 * because a test asserting the unavailable state should not wait for the
 * backoff of a request that is failing on purpose.
 */
